...
namespace CoursesManager.Controllers
{
    ...
    public class CoursesController : ControllerBase
    {
        ...
        public async Task<ActionResult> PutCourse([FromForm] CourseCreateDto course)
        {
            ...
            try
            {
                courseDto = await _courseService.CreateAsync(course, userId, username);
            }
        ...
        public async Task<IActionResult> PatchCourse(Guid id, [FromBody] CourseUpdateDto course)
        {
            ...
            if (!updated) return NotFound(new { error = "Course not found or not owner" });
        ...
        public async Task<IActionResult> DeleteCourse(Guid id)
        {
            ...
            if (!deleted) return NotFound(new { error = "Course not found or not owner" });
